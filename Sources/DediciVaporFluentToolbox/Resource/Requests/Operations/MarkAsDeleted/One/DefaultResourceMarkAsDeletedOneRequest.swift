...
public struct DefaultResourceMarkAsDeletedOneRequest
<Response: ResourceRequestResponse, Resource: CanBeDeleted>: ResourceMarkAsDeletedOneRequest
    where Response.Resource == Resource
{
